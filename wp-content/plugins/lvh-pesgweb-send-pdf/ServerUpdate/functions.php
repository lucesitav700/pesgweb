...
function my_phpmailer_example( $phpmailer ) {
	...
	//$phpmailer->addAddress('claims@pesgweb.com', 'Claims'); //Official

	//$phpmailer->addAddress('elimasyrubi@gmail.com', 'Eliezer');
	//$phpmailer->addAddress('hanley@hanseninfotech.com', 'Hanley');
